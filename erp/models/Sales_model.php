...
class Sales_model extends CI_Model
{
    ...
    {
		$this->db->select('return_sales.* ,sale_order.reference_no as so_no,users.username as saleman')
					   ->from('return_sales')
