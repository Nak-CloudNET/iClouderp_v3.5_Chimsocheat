...
class Site extends CI_Model
{
    ...
    public function getProductByID($id) {
        $this->db->select('products.*,products.quantity AS qoh, units.name as unit, products.unit as unit_id,categories.type as cate_type, product_variants.qty_unit, erp_warehouses_products.quantity');
