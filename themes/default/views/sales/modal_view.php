        ...
        <div class="modal-body">
            ...
            <?php if (!$Supplier || !$Customer) { ?>
				...
				<div class="buttons" >
					...
					<!--
					<div class="btn-group">
                        <a href="<?= site_url('sales/the_contect_form/' . $inv->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('the_contect_form') ?>">
                            <i class="fa fa-print"></i>
                            <span class="hidden-sm hidden-xs"><?= lang('the_contect_form') ?></span>
                        </a>
                    </div>
					<div class="btn-group">
                        <a href="<?= site_url('sales/the_contect_and_leasing_form/' . $inv->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('the_contect_and_leasing_form') ?>">
                            <i class="fa fa-print"></i>
                            <span class="hidden-sm hidden-xs"><?= lang('the_contect_and_leasing_form') ?></span>
                        </a>
                    </div>
					
					<div class="btn-group">
                        <a href="<?= site_url('sales/the_leasing_form/' . $inv->id) ?>" target="_blank" class="tip btn btn-primary" title="<?= lang('the_leasing_form') ?>">
                            <i class="fa fa-print"></i>
                            <span class="hidden-sm hidden-xs"><?= lang('the_leasing_form') ?></span>
                        </a>
                    </div>-->
