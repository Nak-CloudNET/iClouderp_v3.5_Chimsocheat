                                ...
                                <li class="mm_sales mm_sale_order <?= strtolower($this->router->fetch_method()) == 'settings' ? '' : 'mm_pos' ?>">
									...
									<!--	<li id="sales_gift_cards">
										...
										<li id="list_sale_assign">
                                            <a class="submenu" href="<?= site_url('sales/list_saleman_assign'); ?>">
                                                <i class="fa fa-credit-card"></i>
                                                <span class="text"> <?= lang('list_saleman_assign'); ?></span>
                                            </a>
                                        </li>
										<li id="list_sale_clear">
                                            <a class="submenu" href="<?= site_url('sales/list_saleman_clear'); ?>">
                                                <i class="fa fa-credit-card"></i>
                                                <span class="text"> <?= lang('list_saleman_clear'); ?></span>
                                            </a>
                                        </li>
