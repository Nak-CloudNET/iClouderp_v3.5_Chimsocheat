        ...
        <div class="text-center">
            ...
            <tr>
              <td style="vertical-align:middle;text-align:right;font-size:16px;padding-right:10px;" colspan="3"><b>Waiting No</b></td>
						...
						<tr style="text-align:center;">
							...
							<td style="vertical-align:middle;text-align:right;"><?=$this->erp->hrld($inv->date);?></td>

						</tr>

						<tr style="text-align:center;">

							<td style="vertical-align:middle;text-align:left;padding:3px;"><?= lang('saleman') ?></td>
			...
			<table style="width: 100%; margin-top: 5px;">
				<tr>
					...
					<td style="text-align:right;width:35%; padding-right: 5px">Sub Total (<?= $default_currency->code; ?>) :</td>
					<td style="text-align:right;">$ <?=$this->erp->formatMoney($sub_total)?></td>
				</tr>
				<?php if ($inv->order_tax != 0) { ?>
				<tr>
					<td style="text-align:left;">ពន្ធ</td>
					<td style="text-align:right;width:35%; padding-right: 5px">Order Tax (<?= $default_currency->code; ?>) :</td>
					<td style="text-align:right;">$ <?=$this->erp->formatMoney($inv->order_tax)?></td>
				</tr>
				<?php } ?>
				<tr>
					<td style="text-align:left;">បញ្ចុះតំលៃ</td>
					<td style="text-align:right;width:35%; padding-right: 5px">Discount (<?= $default_currency->code; ?>) :</td>
					<td style="text-align:right;">$ <?=$this->erp->formatMoney($inv->order_discount)?></td>
				</tr>
				<tr>
					<td style="text-align:left;">សរុបចុងក្រោយ</td>
					<td style="text-align:right;width:40%; padding-right: 5px">Grand Total (<?= $default_currency->code; ?>) :</td>
