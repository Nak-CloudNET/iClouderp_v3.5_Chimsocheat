        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="well well-sm no-print">
					...
					<div class="form-group">
						<?= lang('style', 'style'); ?>
						<?php $opts = array('' => lang('select').' '.lang('style'),11 => lang('SWAP'), 6 => lang('SBPS'), 10 => lang('AYCollection'),40 => lang('40_per_sheet'), 30 => lang('30_per_sheet'), 24 => lang('24_per_sheet'), 20 => lang('20_per_sheet'), 18 => lang('18_per_sheet'), 14 => lang('14_per_sheet'), 8 => lang('City_Goal'),12 => lang('12_per_sheet'), 50 => lang('continuous_feed'), 16=>lang('new'),90 => lang('a4-col-5')); ?>
